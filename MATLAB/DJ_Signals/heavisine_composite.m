...
for m = 1:M 
 ...
 % Calculate Average MSE for single bases W1 and W2 across M simulations
 ...
 fprintf('| %-22s | %-11s | %-16s |\n', 'Method', 'Average MSE', 'Variance of MSE');
 fprintf('|------------------------|-------------|------------------|\n');
 fprintf('| %-22s | %.4f      | %.4f           |\n', 'Kronecker Product (Symm4, Haar)', avg_mse_kron, var(mse_kron_vec));
 ...
 boxplot([mse_kron_vec, mse_W1W2W1_vec, mse_W1W2_vec, mse_W1_vec, mse_W2_vec], ...
     {'kron', 'W1W2W1', 'W1W2', 'Haar', 'Symmlet 4'});
 ylabel('MSE');
