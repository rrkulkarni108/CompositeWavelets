...
%
   if nargin > 1,
	...
	elseif strcmp(Name,'Wave'),
		sig = 0.5 + (0.2.*cos(4*pi*t)) + (0.1.*cos(24*pi*t));
 
	elseif strcmp(Name,'Blip'),
...
-ones(1,fix(n/2)+2*fix(n/12)+3*fix(n/20)-fix(n/2)-2*fix(n/12)-fix(n/20))*25;
	...
	elseif strcmp(Name,'Time Shifted Sine') | ...
           strcmp(Name,'TSh Sine');
      u = t;
    	for j =1:4,
        u = 0.5*(1-cos(pi*u));
    	end
